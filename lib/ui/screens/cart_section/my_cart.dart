                  ...
                  child: SizedBox(
                    ...
                    //padding: EdgeInsets.all(8),
                      ...
                      child: ListView.separated(
                        itemCount: myCartViewModel.cartList.length,
                      ...
                      children: [
                        Row(
                          ...
                          children:  [
                            ...
                            Text( '\$${( 74.00 * myCartViewModel.cartList.length* myCartViewModel.num).toString()}',
                        ...
                        Row(
                          ...
                          children:  [
                            ...
                            Text("\$ ${(83.0 + myCartViewModel.cartList.length * myCartViewModel.num).toString()}",
                              style: const TextStyle(
                                  color: darkGreenTextColor,
                                  fontSize: 15,
                                  fontWeight: FontWeight.w700
