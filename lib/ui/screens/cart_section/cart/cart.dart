...
// import '../../../custom_widgets/custom_cart_item.dart';
...
//                         itemCount: model.getCartModelList.length,
//                         itemBuilder: (BuildContext context, int index){
//                           return Card(
//                             //color: Colors.black,
//                             child: CustomCartItem(
//                               CustomCartItemPlant: model.getCartModelList[index],
...
//                                 ),
//                               ),
//                               Text( "\$${31* model.getCartModelList.length}",
...
//                                 ),
//                               ),
//                               Text("\$${10+31* model.getCartModelList.length}",
//                                 style: const TextStyle(
//                                     color: darkGreenTextColor,
//                                     fontSize: 15,
//                                     fontWeight: FontWeight.w700
